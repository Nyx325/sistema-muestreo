...
public class Site implements ISite {
  ...
  public Site(
      UUID id, boolean active, String clave, String nombre, Optional<String> cuenca,
      Optional<String> claveAcuifero, Optional<String> acuifero, Optional<String> organismo,
      Optional<String> direccionLocal,
  ...
  public String getSiteDescription() {
    return String.format("Site: %s - %s", getClave(), getNombre());
  }
  ...
  public String[] fieldsToArray() {
    return new String[] {
        ...
        nombre,
        cuenca.orElse("-"),
        claveAcuifero.orElse("-"),
        acuifero.orElse("-"),
        organismo.orElse("-"),
        direccionLocal.orElse("-"),
        estado.orElse("-"),
        municipio.orElse("-"),
        cuerpoAgua.orElse("-"),
        tipoCuerpo.orElse("-"),
        subtipoCuerpo.orElse("-"),
        latitud.orElse("-"),
        longitud.orElse("-"),
        uso.orElse("-"),
        lugarToma.orElse("-"),
